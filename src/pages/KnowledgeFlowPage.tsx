...
export function KnowledgeFlowPage() {
  return (
    <main id="main-content" className="case-page case-page--rag">
      ...
      <CaseSection index="09 / 12" title="界面与来源阅读"><ScreenshotGallery items={[{ path: '/images/knowledgeflow/upload-empty.webp', alt: 'KnowledgeFlow 空状态', width: 1440, height: 900 }, { path: '/images/knowledgeflow/document-list.webp', alt: 'KnowledgeFlow 文档列表', width: 1440, height: 900 }, { path: '/images/knowledgeflow/streaming-chat.webp', alt: 'KnowledgeFlow 流式问答', width: 1440, height: 900 }, { path: '/images/knowledgeflow/source-snapshot.webp', alt: 'KnowledgeFlow 来源快照', width: 1440, height: 900 }, { path: '/images/knowledgeflow/session-restore.webp', alt: 'KnowledgeFlow 浏览器恢复', width: 1440, height: 900 }]} /></CaseSection>
