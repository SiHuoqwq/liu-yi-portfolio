...
export function XishuPage() {
  return (
    <main id="main-content" className="case-page">
      ...
      <CaseSection index="08 / 11" title="界面与证据阅读"><p>以下界面使用公开的合成演示数据，由 Fake Provider 确定性演示模式通过实际产品 UI 生成；用于证明数据画像、结构化 Artifact、Run 状态与可信拒答边界，不作为真实模型效果声明。</p><ScreenshotGallery items={[{ path: '/images/xishu/dataset-profile.webp', alt: '析数合成演示数据的数据集画像', width: 1600, height: 980 }, { path: '/images/xishu/analysis-result.webp', alt: '析数课程类别分析结果', width: 1600, height: 560 }, { path: '/images/xishu/artifact-overview.webp', alt: '析数结构化表格与图表 Artifact', width: 1600, height: 1300 }, { path: '/images/xishu/run-details.webp', alt: '析数已完成运行的执行详情', width: 1600, height: 1000 }, { path: '/images/xishu/boundary-refusal.webp', alt: '析数教师维度数据条件不足说明', width: 1600, height: 900 }]} /></CaseSection>
