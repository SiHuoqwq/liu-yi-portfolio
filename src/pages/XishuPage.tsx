...
export function XishuPage() {
  return (
    <main id="main-content" className="case-page">
      ...
      <CaseSection index="08 / 11" title="界面与证据阅读"><p>以下界面使用公开的合成演示数据，由 DeepSeek 真实模型模式通过实际产品 UI 生成；用于证明数据画像、结构化 Artifact、Run 状态与可信拒答边界。页面展示的是受控工作流与确定性数据计算结果，不将单次模型输出扩大为通用模型能力声明。</p><ScreenshotGallery items={[{ path: '/images/xishu/01_real_estate_overview.png', alt: '析数房地产销售 Demo 数据集画像', width: 1440, height: 1100 }, { path: '/images/xishu/02_real_estate_analysis.png', alt: '析数房地产经营分析结果', width: 1440, height: 1100 }]} /></CaseSection>
