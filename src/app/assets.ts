...
export const assetManifest = {
  ...
  xishuArtifact: { path: '/images/xishu/artifact-overview.webp', available: true, requiredForRelease: true, width: 1600, height: 1300 },
  ...
  xishuRecovery: { path: '/images/xishu/session-recovery.webp', available: true, requiredForRelease: true, width: 940, height: 659 },
