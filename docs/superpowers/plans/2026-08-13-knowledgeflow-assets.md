...
**Architecture:** Reuse the source project's browser acceptance runner, Fake FastAPI backend, installed Playwright/Chrome, and React frontend. Keep all runtime data and PNG intermediates under a dedicated `D:\Codex\Temp\rag-v0.2.0-browser-*` workspace, write only selected WebP deliverables to the portfolio, and limit portfolio code changes to the existing asset manifest plus verification documentation.
...
- Raw PNGs and intermediate files remain in `D:\Codex\Temp`; only selected WebP files enter `public/images/knowledgeflow/`.
...
**Files:**
- Read: `D:\Codex\Projects\langchain-rag-framework\frontend\scripts\fullstack-browser-smoke.mjs`
- Read: `D:\Codex\Projects\langchain-rag-framework\tests\e2e\fake_fullstack_api.py`
- Read: `D:\Codex\Projects\portfolio-implementation\src\app\assets.ts`
- Read: `D:\Codex\Projects\portfolio-implementation\src\app\assets.test.ts`
...
**Files:**
- Create temporarily: `D:\Codex\Temp\rag-v0.2.0-browser-*\demo\ai-knowledge-base-acceptance.md`
- Create temporarily: `D:\Codex\Temp\rag-v0.2.0-browser-*\browser\*.png`
- Create: `D:\Codex\Projects\portfolio-implementation\public\images\knowledgeflow\*.webp`
...
**Files:**
- Modify: `D:\Codex\Projects\portfolio-implementation\src\app\assets.test.ts`
- Modify: `D:\Codex\Projects\portfolio-implementation\src\app\assets.ts`
...
**Files:**
- Create: `D:\Codex\Projects\portfolio-implementation\docs\verification\knowledgeflow-assets.md`
- Create: `D:\Codex\Projects\portfolio-implementation\docs\visual-review-knowledgeflow-assets\*.png`
- Create: `D:\Codex\Projects\portfolio-implementation\docs\visual-review-knowledgeflow-assets\review.json`
...
**Files:**
- Modify: `D:\Codex\Projects\portfolio-implementation\PROJECT_MEMORY.md`
