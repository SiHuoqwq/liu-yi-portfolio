...
- 源项目：`D:\Codex\Projects\langchain-rag-framework`。
...
- 隔离边界：Chroma、uploads、缓存、合成文档、浏览器 profile、日志和原始 PNG 全部位于 `D:\Codex\Temp\knowledgeflow-real-acceptance-20260813-034746`，不提交到仓库；正式 `data/chroma` 与 `data/uploads` 前后指纹一致。
